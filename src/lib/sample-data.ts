...
export const sampleShop: Shop = {
  ...
  name: "MobileHub",
  slug: "mobilehub",
  tagline: "Ihr zuverlässiger Handy-Spezialist vor Ort",
  ...
  hero_images: [
    ...
    "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=1920&auto=format&fit=crop",
  ...
  services: [
    { title: "Handy-Reparatur", icon: "wrench" },
    { title: "Handy-Verkauf", icon: "smartphone" },
    { title: "Zubehör", icon: "headphones" },
    { title: "SIM & Entsperrung", icon: "sim" },
  ],
